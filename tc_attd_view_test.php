        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <ul class="breadcrumb">
                        <li>
                            <a href="tc_index.php">Dashboard</a>
                        </li>
            ...
            <form action="tc_attd_record.php" method="get" id="dateForm">
				<div class="form-header">Class: <?php echo htmlspecialchars($class_name); ?></div>
						...
						if ($result->num_rows > 0) {
							while ($row = $result->fetch_assoc()) {
								echo "<tr>
										...
										<td>{$row['class_name']}</td>
										<td>
											<button type='button' id='present-{$row['student_id']}' class='present-btn present-active' onclick=\"toggleAttendance('{$row['student_id']}', 'present')\">Present</button>
