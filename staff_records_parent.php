            ...
            document.querySelectorAll('.delete-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    Confirm.open({
                        ...
                        onok: () => {
                            location.href = 'staff_delete_parent.php?id=' + noticeId;
                        }
                    });
                });
            });
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li><i class='bx bx-chevron-right' ></i></li>
						<li>
							<a class="active" href="#">Parents' Records</a>
						</li>
					</ul>
				</div>
				...
				<div class="order">
					...
					<div class="search-bar">
						<form method="GET" action="">
							...
							<a href="staff_records_parent.php" class="reset-btn">Reset</a>
						</form>
					</div>
					...
					<table>
						...
						<tbody>
							...
							// Fetch parent records with search filter
							$sql = "SELECT parent_id, first_name, last_name, phone_num, email, password, address FROM parents WHERE first_name LIKE ? OR last_name LIKE ? OR email LIKE ?";
							...
							if ($result->num_rows > 0) {
								...
								while ($row = $result->fetch_assoc()) {
									echo "<tr>
											...
											<td>
												<div class='btn-group'>
													<button class='edit-btn' onclick=\"location.href='staff_parent_user.php?id={$row['parent_id']}'\">Edit</button>
													<button class='delete-btn' data-id='{$row['parent_id']}'>Delete</button>
												</div>
											</td>
										</tr>";
								}
